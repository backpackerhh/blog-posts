...
When I started working at this company I was already assigned to a project, but as I already had booked my vacations, [my start at the American fintech](/the-one-about-my-new-job) was delayed for a few weeks until I was back.
...
*   [BrutRB](https://brutrb.com/):
    
    *   [Documentation](https://brutrb.com/getting-started.html)
...
*   [RuboCop](https://rubocop.org/)
    ...
    *   [How to start using a linter in a legacy project](/the-one-about-linting-in-a-legacy-ruby-project)
...
*   [Upgrow: A Better Architecture](https://github.com/backpackerhh/upgrow-docs):
    ...
    *   Proposed by Shopify and somehow inspired by [DDD](/the-one-with-highlights-of-the-red-book-of-ddd)
...
*   Testing:
    ...
    *   [RSwag](https://github.com/rswag/rswag)/[rspec-swag](https://github.com/raceful-potato/rspec-swag)
...
Recently, I found [RubyFriends](https://rubyfriends.app/), an app that allows people to reconnect after a conference. A great idea!
