...
In the [previous post](/the-one-about-shortcuts-in-cursor-with-karabiner-elements), I mentioned that I was starting to use Cursor as my main IDE, after having worked with VSCode and Copilot for a while.
