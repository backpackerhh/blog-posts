...
Finally, I refactored the esparse tests to route them through the `Dispatcher` instead of testing the proxy in isolation, and added the make command to be able to run those tests locally:
