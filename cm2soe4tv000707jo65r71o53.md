...
Previously, I mentioned that I recently started working on a [new project](https://blog.davidmontesdeoca.es/the-one-about-my-new-job). New for me, of course.
...
For more details about that configuration, take a look to [this other post](https://blog.davidmontesdeoca.es/the-one-about-conditionals-in-ruby).
